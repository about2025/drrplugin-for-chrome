(() => {
 ...
 // 無視するユーザーの正規表現を登録（必要に応じて追加・変更可能）
  const ignoredNamePatterns = ["名無し", "マイキー", "新田隼人", "ﾄﾞｼﾀ", "社会の現実", "^ぷに$", "^たき$", "^猫魔符$", "野球くん", "真アコ兄", "ミチコ", "アサイー", "@◇@", "屁", "みみみ", "隼人", "苦夫", "ぷにゃぷにゃ", "レレレ", "深淵", "rakan", "ちひろ", "さそり", "ニンニクましまし", "(?<!駆け抜ける)熊", "山の幸", "ここなつ", "丘介", "はまいち", "失敗作少女", "♪", "のび", "さかな", "オフショア", "民", "顎", "あすか", "ぶぶ", "カイジ", "たろ", "あいすん", "納豆|なっと", "おじゆき", "きたがわ", "なめくじ", "赤羽", "おそ松", "ネカマ侍", "タケミカヅチ", "猫ぷは", "正明", "カナ$", "せこ", "なめし", "のろ", "山下", "kranky", "サンドラ", "JACK", "人生の勝者", "100日後", "豆", "ぷか", "^雨$", "^ぱぁる$", "松", "うんこ", "桜井誠", "はげおやじ", "人生終了", "ハル", "ニトヒロ", "おすし", "ゆう", "雨宮", "巨大", "うさぎ", "バージニア", "A.*a", "パンツ", "高学歴", "です", "ケン", "^け$", "^ライダー$", "^まこと$", "^伊藤", "^クマ", "たけし", "丸亀", "渡邊", "TK", "モチヤマ", "春爛漫", "yama", "まりりん", "こうん", "柏", "森崎", "なるみ", "すまお", "どる", "田中", "とも", "障害", "カイジ"];
